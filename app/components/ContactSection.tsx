		...
		<section id="contact" className="py-12 sm:py-20 px-4 bg-[#161B22] scroll-mt-20">
			<div className="max-w-4xl mx-auto text-center px-4 sm:px-6">
				...
				<div className="flex flex-col sm:flex-row justify-center gap-4 mb-8">
					<a
						href="mailto:protikprotik49@gmail.com"
					...
					<a
						href="https://drive.google.com/file/d/1LbM-ZMUbkoxaMviNaEGYujVgMfZqlBJC/view?usp=sharing"
						target="_blank"
				...
				<div className="flex justify-center gap-6">
					<a
						href="https://github.com/Protik49"
						target="_blank"
					...
					<a
						href="https://www.linkedin.com/in/touhidul-islam-protik-183109357"
						target="_blank"
						rel="noopener noreferrer"
						className="text-gray-400 hover:text-white transition-colors p-2 hover:bg-gray-800 rounded-lg"
					>
